...
export class SampleComponent extends ComponentBase implements OnInit, OnDestroy {
  ...
  onExecuteQuerys() {
    ...
    this.sampleService.getDataCustom({ sampleId: 1 }).subscribe((response => {
      console.log("getDataCustom", response);
    }))

    this.sampleService.getDataListCustom().subscribe((response => {
      console.log("getDataListCustom", response);
    }))

    this.sampleService.getDataListCustomPaging().subscribe((response => {
      console.log("getDataListCustomPaging", response);
    }))
